        ...
        <div className="space-y-2 max-h-60 overflow-y-auto">
          {friends.map((friend) => (
            <Card
              ...
              key={friend._id}
              className="p-3 cursor-pointer transition-smooth hover:shadow-soft glass hover:bg-muted-foreground/30 group/friendCard "
            >
          ...
          {friends.length === 0 && (
            <div className="text-center py-8 text-muted-foreground">
              <Users size={12} className="mx-auto mb-3 opacity-50" />
