    ...
    <SidebarInset className="flex w-full h-full bg-transparent">
      ...
      <div className="flex bg-primary-foreground rounded-2xl flex-1 items-center justify-center">
        <div className="text-center">
          ...
          <h2 className="text-2xl font-bold mb-2 bg-gradient-chat bg-clip-text text-transparent">Chao mung den voi Chat Application</h2>
          <p className="text-muted-foreground">Chon mot cuoc hoi thoai de bat dau</p>
        </div>
      </div>
    </SidebarInset>
  )
